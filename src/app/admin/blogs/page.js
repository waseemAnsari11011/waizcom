...
const BlogList = () => {
    ...
    if (session.status === "authenticated") {
        return (
            <div className="min-h-screen bg-gray-100 p-8 pt-10"> {/* Adjusted padding since sidebar handles layout */}
                <div className="mx-auto max-w-7xl">
                    <div className="mb-8 flex items-center justify-between">
                        <h1 className="text-3xl font-bold text-gray-800">All Blogs</h1>
                        {/* Moved Create button local to this page if needed, or rely on sidebar. 
                            The sidebar has "Create Blog". But a page-level button is good UX too. 
                        */}
                    </div>
