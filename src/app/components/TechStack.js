const TechMenu = ({ img, title, subTitle }) => {
  return (
    <div className="backdrop-blur-sm cursor-pointer min-w-[180px] w-[180px] h-[130px] border-[0.5px] bg-[#1E2A2E] border-[#747e8b80] py-[10px] px-[20px] rounded-xl group hover:bg-gradient-to-b from-white/30 to-transparent max-md:min-w-[150px] max-md:w-[150px] ">
...
const TechStack = () => {
  ...
  return (
    <div className="w-full mx-auto my-5 relative bg-[url(/images/tech-bg.png)] bg-cover bg-no-repeat effect">
