              ...
              {step === 0 && (
                 <div className="text-center py-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <p className="text-gray-600 text-lg max-w-lg mx-auto leading-relaxed">
                        Planning an app? Get a detailed cost and timeline estimate in less than a minute. No obligations, just clarity.
                    </p>
                    <div className="pt-6">
                        <button
                            onClick={handleNext}
                    ...
                    <div className="pt-4 flex justify-center gap-8 text-sm text-gray-500">
                        <span className="flex items-center gap-1"><MdCheck className="text-green-500" /> Instant Results</span>
                        <span className="flex items-center gap-1"><MdCheck className="text-green-500" /> Detailed Breakdown</span>
                    </div>
                 </div>
              )}
              ...
              {step > 0 && step <= config.questions.length ? (
                    ...
                    {config.questions[step - 1].options.map((opt, idx) => {
                        ...
                        return (
                            <button
                                ...
                                className={`p-4 rounded-xl border-2 text-left transition-all hover:bg-blue-50 flex justify-between items-center group ${
                                isSelected
                ...
                <div className="text-center py-8 space-y-6 animate-in slide-in-from-right duration-500">
                  ...
                  <p className="text-gray-600 max-w-md mx-auto">
                    We've calculated the cost and timeline for your app. Enter your email to view the detailed breakdown immediately.
                  </p>
                ...
                <div className="text-center py-8 space-y-8 animate-in zoom-in duration-500">
                    ...
                    <p className="text-gray-500 max-w-md mx-auto">
                        This is a rough estimate based on your inputs. For a precise quote and technical proposal, let's connect.
                    </p>
