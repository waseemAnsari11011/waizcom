          ...
          <div className="absolute inset-0 flex items-center">
            <div className="text-left text-white p-4 w-full sm:w-1/2">
              ...
              <p className="mt-2 sm:mt-4 text-base sm:text-lg">
                Discover how we transformed our client's business with a
                cutting-edge multi-vendor e-commerce platform. Our custom-built
                solution delivers seamless features and robust functionalities,
                including:
              </p>
              <ul className="mt-4 list-disc list-inside">
                <li className="mt-2 sm:mt-4 text-base font-medium sm:text-lg">
                  Feature of Product Variation, Color, Weight, Size
                </li>
                <li className="mt-2 sm:mt-4 text-base font-medium sm:text-lg">
                ...
                <li className="mt-2 sm:mt-4 text-base font-medium sm:text-lg">
                  Automatic current location Picking for shipping address
                </li>
                <li className="mt-2 sm:mt-4 text-base font-medium sm:text-lg">
                  OTP Authentication
                </li>
                ...
                <li className="mt-2 sm:mt-4 text-base font-medium sm:text-lg">
                  Order Placement With & Without Chat
                </li>
                <li className="mt-2 sm:mt-4 text-base font-medium sm:text-lg">
